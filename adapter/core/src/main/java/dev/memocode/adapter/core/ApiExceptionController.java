...
import static dev.memocode.adapter.core.CoreAdapterErrorCode.VALIDATION_ERROR;
...
public class ApiExceptionController {
    ...
    public ResponseEntity<ErrorResponse> exception(Exception ex) {
        ...
        ErrorResponse response = ErrorResponse.builder()
                .code(CoreAdapterErrorCode.INTERNAL_SERVER_ERROR.getErrorCode())
                .message(CoreAdapterErrorCode.INTERNAL_SERVER_ERROR.getDefaultMessage())
                .build();
    ...
    public ResponseEntity<ErrorResponse> constraintViolationException(ConstraintViolationException ex) {
        ...
        ConstraintViolation<?> constraintViolation = ex.getConstraintViolations().stream().findFirst()
                .orElseThrow(() -> new InternalServerException(CoreAdapterErrorCode.INTERNAL_SERVER_ERROR));
